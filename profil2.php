            ...
            <div class="well well-sm">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <!-- Split button -->
												<div class="btn-group">
                            <form action="izmeni3.php">
                                <input type="submit" value="Измени профил" class="btn btn-primary">
                            </form>
                        </div>
                    </div>
                </div>
...
$korisnik=$_SESSION["login_user"];
   $pom="SELECT * FROM postovi where idkorisnik='$korisnik' ORDER BY idpostovi desc";
