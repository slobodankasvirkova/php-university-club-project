...
<html>
  ...
  <br>
            ...
            <div class="row">
                        ...
                        <form action = "izmeni2.php" method = "post" enctype="multipart/form-data">
                              <div class="form-group row">
                                <label for="password" class="col-4 col-form-label">Лозинка</label> 
                                <div class="col-8">
                                  <input id="password" name="password" placeholder="Лозинка" class="form-control here" required="required" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="god" class="col-4 col-form-label">Години</label> 
                                <div class="col-8">
                                  <input id="god" name="god" placeholder="Години" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="email" class="col-4 col-form-label">E-mail</label> 
                                <div class="col-8">
                                  <input id="email" name="email" placeholder="E-mail" class="form-control here" type="text">
                                </div>
                              </div>
                              
                              <div class="form-group row">
                                <label for="select" class="col-4 col-form-label">Факултет:</label> 
                                <div class="col-auto my-1">
                                  <select id="fax" name="fax" class="custom-select mr-sm-2" style="color:black">
                                    <option value=""></option>
                              ...
                              <div class="form-group row">
                                <label for="text" class="col-4 col-form-label">Слика</label> 
                                <div class="col-8">
                                <input type="file" name="slika" id="slika" required="required" class="form-control-file" >
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                  <button name="submit" type="submit" class="btn btn-primary">Промени</button>
                                </div>
                              </div>
                            </form>
		                </div>
