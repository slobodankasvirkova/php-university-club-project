...
<html>
  ...
  <br>
					<p style="color: whitesmoke">Репортирани постови</p>
				</div>
			</div>
 ...
 <div class='span8'>
   ...
   <div class='row' style='color: whitesmoke'>
	 <div class='span8'>
	   ...
	   <p>
		 <i class='icon-user'></i> Постирано од  <a href=''>$row2[1]</a> 
		 | <i class='icon-calendar'></i> $row2[3]
		 | <i class='icon-comment'></i> $row2[4]<a href='$link'> Ми се допаѓа</a>
         |  <i class='icon-comment'></i> <a href='$link2'> Избриши</a>
         |  <i class='icon-comment'></i> <a href='$link3'> Остави</a>
